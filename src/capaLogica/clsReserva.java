...
public class clsReserva {
    ...
    public Integer generarCorrelativo() throws Exception {
        strSQL = "select COALESCE(Max(correlativo),0)+1 as codigo from reserva";
        try {
            ...
            throw new Exception("Error al generar correlativo de reserva: " + e.getMessage());
        }
        return 0;
    }
    ...
    public Integer generarCodReserva() throws Exception {
        try {
            ...
            throw new Exception("Error al generar código de reserva: " + e.getMessage());
        }
    }
